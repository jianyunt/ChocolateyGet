...
## [3.0.1] - 2021-04-02
#### Changed
* Switched default behavior under PowerShell 5.1 to use the CLI method for interacting with choco.exe due to [a compatibility issue between the Chocolatey API and Chocolatey.org](https://github.com/jianyunt/ChocolateyGet/issues/24)
